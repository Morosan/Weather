...
// @param {string} Event Type e.g.: "click", "mouseover"
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        tempLi.innerHTML = `
          <div class="card card-sm slider-card">
            ...
            <img src="./assets/images/weather_icons/${icon}.png" width="48" height="48" loading="lazy" alt="${description}" class="wheather-icon" title="${description}">
        ...
        windLi.innerHTML = `
          <div class="card card-sm slider-card">
            ...
            <img src="./assets/images/weather_icons/direction.png" width="48" height="48" loading="lazy" alt="direction" class="wheather-icon" style="transform: rotate(${windDirection - 180}deg)">
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        li.innerHTML = `
          <div class="icon-wrapper">
            <img src="./assets/images/weather_icons/${icon}.png" height="36" width="36" alt="${description}" class="weather-icon">
            <span class="span">
