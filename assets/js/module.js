...
export const aqiText = {
  1: {
    level: "Good",
    message: "Air quality is consider satisfactory, and air pollution poses little or no risk",
  },
  2: {
    level: "Fair",
  ...
  5: {
    level: "Very Poor",
    message: "Health warnings of emergency contitions. The entire population is more likely to be affected.",
  }
}